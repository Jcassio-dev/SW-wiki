...
import { FaSpaceShuttle, FaPowerOff } from 'react-icons/fa';
    ...
    return(
        <header className="w-full bg-black flex items-center justify-between px-5 py-5 text-white font-medium border-b border-gray-800 fixed top-0 left-0">
            ...
            </nav>
            {
                ...
                :
                <button onClick={() => navigate('/')} className='flex items-center content-center gap-2 border border-gray-700 px-3 py-3 text-base rounded-md transition duration-500 hover:bg-yellow-300 hover:text-black'>
