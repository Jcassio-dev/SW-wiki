    ...
    return(
        <header className="bg-black flex items-center justify-between px-5 py-5 text-white font-medium border-b border-gray-800">
            ...
            <nav className='desktop:flex tablet:flex items-center gap-5 mobile:hidden'>
                <a className={`flex items-center gap-1.5 transition duration-300 cursor-pointer hover:text-yellow-300 pb-2 ${page == 1 && 'border-b-4 border-yellow-300 mt-1'}`}>
                    <BsPersonCircle className='text-2xl'/> <p className='mb-1 text-xl'>Personagens</p>
                </a>
                <a className={`flex items-center gap-1.5 transition duration-300 cursor-pointer hover:text-yellow-300 pb-2 ${page == 2 && 'border-b-4 border-yellow-300'}`}>
                    <GiLightSabers className='text-2xl'/> <p className='mb-1 text-xl'>Armas</p>
                </a>
                <a className={`flex items-center gap-0.5 transition duration-300 cursor-pointer hover:text-yellow-300 pb-2 ${page == 3 && 'border-b-4 border-yellow-300'}`}>
